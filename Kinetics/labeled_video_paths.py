...
class LabeledVideoPaths:
    ...
    @classmethod
    def from_path(cls,data:int,data_path: str) -> LabeledVideoPaths:
        """
        ...
        if g_pathmgr.isfile(data_path):
            ...
            return LabeledVideoPaths.from_directory(data,data_path)
        else:
    ...
    @classmethod
    def from_directory(cls=None,data=None, dir_path: str="") -> LabeledVideoPaths:
        """
        ...
        if data is not None:    
            video_paths_and_label = [(file_name,cl) for file_name,cl in video_paths_and_label if data == cl]
        assert (
            len(video_paths_and_label) > 0
